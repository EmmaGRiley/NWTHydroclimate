...
devtools::install_github("yourusername/snow")

# Or install from local directory
devtools::install("path/to/snow")
```
...
- `get_data_path()`: Get path to package data directory
- `get_external_data_path()`: Locate external data files
...
**Before Running Scripts**: 
   ...
   - Ensure external dependencies (shapefiles, ERA5 data) are available
...
```
Gregory, E. (2025). snow: Snow Water Equivalent Analysis and Trend Detection. 
...
- **0.1.0** (2025): Initial package release
